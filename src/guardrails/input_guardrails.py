    ...
    async def on_user_message_callback(
        ...
        *,
        ...
        if detect_injection(text):
            ...
            return self._block_response("Access Denied: Prompt injection detected. This interaction has been logged.")

        # 2. Call topic_filter(text)
        if topic_filter(text):
            self.blocked_count += 1
            return self._block_response("Access Denied: The query is off-topic or violates safety guidelines. I can only assist with banking-related inquiries.")
